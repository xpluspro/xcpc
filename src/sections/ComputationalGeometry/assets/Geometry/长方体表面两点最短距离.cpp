long long r;
void go(int i, int j, long long x, long long y, long long z,long long x0, long long y0, long long L, long long W, long long H) {
if (z==0) { long long R = x*x+y*y; if (R<r) r=R;}
else {
