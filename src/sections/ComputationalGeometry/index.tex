...
\subsection{数值与实现注意事项}
	\input{sections/ComputationalGeometry/assets/numerical-pitfalls.tex}
...
\subsection{多边形}
	...
	\subsubsection{简单多边形内最长线段}
		...
		\subsubsection{O(n²) Ear Clipping 三角剖分}
...
\subsection{凸几何}
	...
	\subsubsection{半平面可行性（退化、无界与参数区间）}
        \input{sections/ComputationalGeometry/assets/halfplane-usage.tex}
		\inputminted{cpp}{sections/ComputationalGeometry/assets/Geometry/halfplane_feasible_closed.cpp}
